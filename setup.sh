...
# c2clat (see https://gist.github.com/geerlingguy/842974c0e49c201c28f4be54a05cc89c)
git clone https://github.com/rystsov/c2clat.git && cd ~/c2clat && make && cd ~ || \
